      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mb-6 md:mb-0">
            <a href="https://www.instagram.com/dayleaf_writing/?hl=en" className="text-indigo-300 hover:text-indigo-200 transition-colors duration-300">
            ...
            <a href="https://substack.com/@dayfog" className="text-indigo-300 hover:text-indigo-200 transition-colors duration-300">
        ...
        <g>
            ...
            <a href="https://www.goodreads.com/user/show/7769970-dayle-fogarty" className="text-indigo-300 hover:text-indigo-200 transition-colors duration-300">
            <div className="w-5 h-5 flex items-center justify-center">
            <GoodReadsLogo className="w-full h-full" />
            </div>
            </a>
            <a href="https://www.threads.net/@dayleaf_writing" className="text-indigo-300 hover:text-indigo-200 transition-colors duration-300">
