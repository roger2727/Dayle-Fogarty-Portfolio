...
const ContactSection = () => {
  ...
  const socialLinks = [
    {
      ...
      url: 'https://www.instagram.com/dayleaf_writing/?hl=en'
    },
    {
      name: 'Threads',
      icon: (
      ...
      url: 'https://www.threads.net/@dayleaf_writing'
    },
    {
      name: 'Goodreads',
      icon: (
      ...
      url: 'https://www.goodreads.com/user/show/7769970-dayle-fogarty'
    },
    {
      name: 'Substack',
      icon: (
  ...
  <div>
    ...
    <a 
      href="mailto:fogartydayle@gmail.com" 
      onClick={() => window.location.href = 'mailto:fogartydayle@gmail.com'}
      title="Send email to Dayle Fogarty"
      className="text-sm text-gray-300 hover:text-indigo-200 transition-colors duration-300"
    >
      fogartydayle@gmail.com
    </a>
  </div>
</div>
