...
const ProjectsSection = () => {
  ...
  // Updated book data to reflect the actual primary project with neutral status
  const featuredProject = {
    ...
    completion: 100, // manuscript is complete
  ...
  return (
    <section id="projects" className="bg-slate-950 text-gray-200 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Featured Project Section - modernized design with animations */}
        <div className="mb-20">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            {/* Book Cover with Agency Review Overlay - glass morphism style */}
